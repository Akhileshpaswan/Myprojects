	...
	try
{
		...
		int i=st.executeUpdate("update productreg set gstax='"+a2+"',pdnm='"+a3+"',purdt='"+a4+"',mncost='"+a5+"',mncity='"+a6+"',email='"+a7+"',dtmn='"+a8+"',gstno='"+a9+"',pdbd='"+a10+"',hsncd='"+a11+"',avail='"+a12+"'  where pdid='"+a1+"' ");
