...
<div  style="position:relative; height:230px; width:1100px; background-color:#0000CC; "> 
...
<tr><td></td><td><label for="text">Vendor ID</label></td><td>1236</td><td><label for="text">Vendor Name</label></td><td>Akhilesh</td><td><label for="text"> Date of birth</label></td><td>20/08/2002</td><td></td><td></td><td></td></tr>
<tr><td></td><td><label for="text">VEndor Education</label></td><td>B.tech,M.tech</td><td><label for="text">Vendor Email ID</label></td><td>akhileshkumarpaswan966@gmail.com</td><td><label for="text"> Vendor GST No</label></td><td>XYZ10200YY</td><td></td><td></td><td></td></tr>
<tr><td></td><td><label for="text">Ve</label></td><td>Dev Bhoomi Uttarakhand University</td><td><label for="text">State</label></td><td>uttakhand</td><td><label for="text">Vendor company</label></td><td>DR Engineering</td><td></td><td></td><td></td></tr>
<tr><td></td><td><label for="text">City</label></td><td>Dehradunn</td><td><label for="text">pin code</label></td><td>2492005</td><td><label for="text">Counter Nmae</label></td><td>India</td><td></td><td></td><td></td></tr>
<tr><td></td><td><label for="text">Employee Phone NO.</label></td><td>+917300932385</td><td><label for="text">Employee Job TYpe</label></td><td>Privet lavel</td><td><label for="text">Employee salary</label></td><td>80k+</td><td></td><td></td><td></td></tr>
<tr><td></td><td><input type="submit" value="Update"></td><td></td><td><input type="submit" value="Remove"></td><td></td><td><label for="text"></label></td><td></td><td></td><td></td><td></td></tr>
</table>
</div>
</td></tr>
</table>
