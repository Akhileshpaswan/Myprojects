...
a12=(request.getParameter("V12"));
 ...
 out.print("<br>Vendor ID="+a1);
  out.print("<br>Vendor Name="+a2);
   out.print("<br>Vendor Mobile No="+a3);
    out.print("<br>Company Name="+a4);
	 out.print("<br>Vendor GST No="+a5);
	  out.print("<br>Adress="+a6);
	   out.print("<br>Pin Code="+a7);
	    out.print("<br>City="+a8);
		 out.print("<br>Email ID="+a9);
		  out.print("<br>State="+a10);
		   out.print("<br>Country="+a11);
...
try
{
		...
		int i=st.executeUpdate("update vendortable set vdnm='"+a2+"',vdcpnm='"+a3+"',vdgstno='"+a4+"',vdadd='"+a5+"',vdpin='"+a6+"',vdcity='"+a7+"',vdemail='"+a8+"',vdst='"+a9+"',vdcp='"+a10+"',vdpt='"+a11+"',vdrs='"+a12+"' where vdid='"+a1+"' ");
